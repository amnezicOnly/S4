...
public class Plant extends Players{
	...
	public ArrayList<Cell> hasEnoughNeighbor(Cell[][] board){
		...
		// haut
		if((this.Y)+1<max && couldEat(board[(this.X)][(this.Y)+1].currentPlayer)){
		...
		// haut droite
		if((this.X)+1<max && (this.Y)+1<max && couldEat(board[(this.X)+1][(this.Y)+1].currentPlayer)){
		...
		// droite
		if((this.X)+1<max && couldEat(board[(this.X)+1][(this.Y)].currentPlayer)){
		...
		// bas droite
		if((this.X)+1<max && (this.Y)-1>=0 && couldEat(board[(this.X)+1][(this.Y)-1].currentPlayer)){
			res.add(board[(this.X)+1][(this.Y)-1]);
			couldEat++;
		}
		...
		// bas
		if((this.Y)-1>=0 && couldEat(board[(this.X)][(this.Y)-1].currentPlayer)){
			res.add(board[(this.X)][(this.Y)-1]);
			couldEat++;
		}
		...
		// bas gauche
		if((this.X)-1>=0 && (this.Y)-1>=0 && couldEat(board[(this.X)-1][(this.Y)-1].currentPlayer)){
			res.add(board[(this.X)-1][(this.Y)-1]);
			couldEat++;
		}
		...
		// gauche
		if((this.X)-1>=0 && couldEat(board[(this.X)-1][(this.Y)].currentPlayer)){
			res.add(board[(this.X)-1][(this.Y)]);
			couldEat++;
		}
		...
		// haut gauche
		if((this.X)-1>=0 && (this.Y)+1<max && couldEat(board[(this.X)-1][(this.Y)+1].currentPlayer)){
			res.add(board[(this.X)-1][(this.Y)+1]);
			couldEat++;
		}

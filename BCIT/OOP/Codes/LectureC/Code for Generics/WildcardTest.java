...
public class WildcardTest 
{
   ...
   //ArrayList<?> list would allow any ArrayList but with no upper bound
   //ArrayList<? extends Number> list allows only ArrayLists that can only contain Number elements
   //Note: with wildcards you CANNOT add elements to the ArrayList as the type is unknown
   //thus passing even ArrayList<Integer> 

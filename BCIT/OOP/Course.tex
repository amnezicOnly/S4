...
Le mot-clé static permet de partager certaines variables et méthodes avec toutes les instances d'une même classe.\newline
Pas besoin de caster un élément dans une classe dont il hérite.
